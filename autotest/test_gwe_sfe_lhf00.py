...
cases = ["sfe-abc-kel", "sfe-abc-fah", "sfe-abc-cel"]
...
rwid = 1.0
strm_temp_C = 11.0
strm_temp = [strm_temp_C + DCTOK, 51.8, strm_temp_C]
surf_Q_in = [[10.0], [10.0], [10.0]]
#                       K,             F,      C
...
def check_output(idx, test):
    ...
    msg3 = "MF temp change: " + str(strm_temp[idx] - df2.loc[0, "RCH1_OUTFTEMP"])
